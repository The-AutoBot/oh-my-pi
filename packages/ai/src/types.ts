...
import type { AnyType } from "@oh-my-pi/omptype";
import type {
	DeleteArgs,
	DeleteResult,
	DiagnosticsArgs,
 ...
 */
export type TSchema = AnyType | TJsonSchema;

/** Resolve parameter types for tool execution / handlers. */
export type Static<S> = S extends AnyType ? S["infer"] : S extends { static: infer T } ? T : unknown;
