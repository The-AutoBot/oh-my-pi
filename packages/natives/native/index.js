 ...
 * `undefined`. Current addons preserve capability probes for unsupported
 * symbols, while a loader status that identifies version drift produces an
 * actionable error naming the stale addon instead of a later
 * `<symbol> is not a function` failure.
 */
...
export const __piNativesV18_2_7 = nativeBindings.__piNativesV18_2_7;
